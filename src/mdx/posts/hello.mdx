---
title: "Hello!"
description: "Remade the site, and new basic setup."
coverImage: "/images/posts/post-1.png"
date: "13-12-2022"
---

Well hello there again- site's abit new(?). I really like this new layout haha. The old site is still up <a href="https://blog.zochy.xyz" target="_blank">here</a>- just it won't be getting any new blog posts.
...
-   Code blocks will now display the <a href="https://highlightjs.org/static/demo/#Tokyo%20Night%20Dark" target="_blank">tokyo-night-dark.css</a> theme.
...
5. Push the changes.
6. Host on <a href="https://vercel.com" target="_blank">Vercel</a> or similar.
