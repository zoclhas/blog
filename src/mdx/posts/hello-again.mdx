...
Hello! This is gonna a bit of a short blog post, buttttt let's get into the redesign of [zoclhas.com](https://zoclhas.com). Don't worry- you can still view the previous of the site [here](https://v4.zoclhas.com).
...
Well that's all I've got for this post. Again I'm really like the new redisgn, and it got some pretty **amazing** scores on [pagespeed.web.dev](https://pagespeed.web.dev). You can visit the website [here](https://zoclhas) and checkout it's [GitHub repo](https://github.com/zoclhas/zoclhas-v5).
